...
function Portfolio() {
    const projects = [
      ...
      },
      {
        ...
        description: "I enhance a fully functioning Tech Quiz application by adding Cypress for both component and end-to-end testing.",
        imageSrc: testingCypress,
        deployedLink: "https://drive.google.com/file/d/1P6qn4crjZkXYAXJ4WpwGAZasHFRcZ_vH/view",
        repoLink: "https://github.com/snabaj/testing-with-cypress",
      },
      {
        title: "GitHub Actions CI/CD",
        description: "I create a CI/CD pipeline using GitHub Actions to run the component tests via Cypress when a Pull Request is made to the develop branch.",
      ...
      },
      {
        ...
        description: "I refactor a fully functioning Google Books API search engine built with a RESTful API to a GraphQL API built with Apollo Server.",
        imageSrc: bookSearch,
      ...
      {
        title: "Career Gist",
        description: "An advanced job board aggregator designed to streamline the job search process by fetching listings from the JSearch API.",
        imageSrc: careerGist,
      ...
      {
        title: "Kanban Board",
        description: "A full-stack application that uses JSON Web Tokens to provide a secure and scalable method for verifying user identities.",
      ...
      },
      {
        ...
        description: "An application that uses React and TypeScript to call the GitHub API and render data in the browser.",
        imageSrc: candidateSearch,
        deployedLink: "https://drive.google.com/file/d/1kiDNWL6drCGyRIGvGYJj1UQ3hrLHnhtz/view",
        repoLink: "https://github.com/snabaj/candidate-search-application",
      },
      {
        title: "Social Network API",
        description: "An API for a social network web application where users can share their thoughts and reactions with friends.",
        imageSrc: socialApi,
        deployedLink: "https://drive.google.com/file/d/1fSbMlApanz75PKGDuCi1Zfrl9omLJfzK/view",
